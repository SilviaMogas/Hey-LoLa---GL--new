        ...
        <div className="max-w-5xl mx-auto space-y-6">
          ...
          >
            ...
            <h1 className="text-3xl md:text-4xl font-black italic tracking-tighter leading-[0.9] text-charcoal">
              Built with local <span className="text-stone-300">dog voices</span><span className="text-brand-orange">.</span>
            </h1>
        ...
        <div className="max-w-2xl mx-auto">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-3xl font-serif italic tracking-tight">
              Creator application<span className="text-brand-orange">.</span>
            </h2>
          ...
          {isSubmitted ? (
            ...
            >
              ...
              <div className="space-y-3">
                <h3 className="text-3xl font-serif italic text-charcoal">Application received<span className="text-brand-orange">.</span></h3>
