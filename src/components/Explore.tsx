      ...
      <div className="flex flex-col gap-4">
        <div className="space-y-1">
           <h2 className="text-2xl md:text-3xl font-black italic tracking-tighter leading-[0.95] max-w-xl text-charcoal">
             {personaliseHeadline ? (
               <>Explore <span className="text-stone-300">{CITIES[activeCity].name}</span><span className="brand-dot" aria-hidden="true"></span></>
             ) : (
               <>Start <span className="text-stone-300">exploring</span><span className="brand-dot" aria-hidden="true"></span></>
             )}
           </h2>
    ...
    <section className="mt-6 pt-12 border-t border-stone-line space-y-8">
      ...
      <div className="space-y-3 max-w-2xl">
        <h3 className="text-3xl md:text-4xl font-black italic tracking-tighter leading-[0.95] text-charcoal">
          {t.explore.voteSectionTitle}<span className="brand-dot" aria-hidden="true"></span>
        </h3>
