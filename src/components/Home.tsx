        ...
        >
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <h2 className="text-3xl md:text-4xl font-serif tracking-tight leading-[0.85] text-charcoal italic">
              Trusted <br /><span className="text-stone-300">Cities<span className="brand-dot" aria-hidden="true"></span></span>
            </h2>
        ...
        <div className="max-w-7xl mx-auto space-y-6 sm:space-y-8 relative z-10">
          ...
          >
            <div className="space-y-5 sm:space-y-6 md:space-y-8 max-w-2xl border-l border-stone-200 pl-5 sm:pl-8 md:pl-10">
              ...
              <h2 className="text-3xl sm:text-3xl lg:text-3xl tracking-tight leading-[0.9] font-serif italic text-charcoal">Travel <span className="text-stone-300">Hub</span><span className="brand-dot" aria-hidden="true"></span></h2>
            ...
            >
              <div className="space-y-4">
                ...
                <h2 className="text-3xl sm:text-3xl md:text-4xl font-serif italic tracking-tight leading-[0.85] text-white">
                  Hey Lola<br /><span className="text-white/30">Club</span><span className="brand-dot" aria-hidden="true"></span>
                </h2>
              </div>
          ...
          >
            <div className="space-y-6 max-w-2xl border-l-2 border-stone-300 pl-8">
              ...
              <h2 className="text-3xl sm:text-3xl font-serif italic tracking-tight leading-none">
                Built with local<br /><span className="text-stone-300">dog voices</span><span className="brand-dot" aria-hidden="true"></span>
              </h2>
      ...
      <section id="how-it-works" aria-labelledby="how-heading" className="py-12 sm:py-16 px-5 sm:px-6 max-w-7xl mx-auto border-t border-stone-100">
        <header className="text-center space-y-3 mb-10 max-w-2xl mx-auto">
          ...
          <h2 id="how-heading" className="text-3xl sm:text-4xl font-serif italic tracking-tight leading-[0.95]">
            One trusted space, three audiences<span className="brand-dot" aria-hidden="true"></span>
          </h2>
      ...
      <section id="concierges" className="py-16 sm:py-24 px-5 sm:px-6 bg-stone-50/50 relative overflow-hidden">
        <div className="max-w-7xl mx-auto space-y-16 relative z-10">
          <div className="text-center space-y-4">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-serif italic tracking-tight leading-none">Meet the <span className="text-stone-300">Concierges</span><span className="brand-dot" aria-hidden="true"></span></h2>
              ...
              {isSubmitted ? (
                <div className="text-center space-y-6 sm:space-y-8 py-8 sm:py-8">
                  ...
                  <div className="space-y-3">
                    <h2 className="text-3xl sm:text-3xl md:text-4xl font-serif italic text-charcoal leading-none">Insight Received<span className="brand-dot" aria-hidden="true"></span></h2>
