          ...
          >
            <div className="space-y-6">
               ...
               <h1 className="text-8xl font-black tracking-tighter leading-none">
                 {nameForWelcome ? (
                   <>{t.onboarding.welcome} <span className="text-stone-300">{nameForWelcome}<span className="brand-dot" aria-hidden="true" /></span></>
                 ) : (
        ...
        {step === 1 && (
          ...
          >
            <div className="space-y-4">
              <h1 className="text-8xl font-black tracking-tighter leading-none">
                <span className="italic font-light text-stone-400">{t.dashboard.greeting}</span> <span className="text-charcoal">{userName?.split(" ")[0] || "there"}</span><span className="brand-dot" aria-hidden="true" />
              </h1>
        ...
        {step === 2 && (
          ...
          >
            ...
            <div className="space-y-2">
              <h1 className="text-2xl sm:text-3xl font-black tracking-tighter">{t.onboarding.snapTitle} <span className="text-charcoal">{petData.name}</span><span className="brand-dot" aria-hidden="true" /></h1>
