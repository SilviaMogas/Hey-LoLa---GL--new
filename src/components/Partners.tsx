  ...
  return (
    <div className="bg-bone min-h-screen font-boutique">
        ...
        <div className="max-w-5xl mx-auto space-y-6 relative z-10">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black italic tracking-tighter leading-[0.9] text-charcoal">
              ...
              <span className="text-stone-300">dog-friendly network</span><span className="brand-dot" aria-hidden="true"></span>
            </h1>
      ...
      <section className="px-5 sm:px-6 py-16 bg-white border-y border-stone-100">
        <div className="max-w-5xl mx-auto">
          <div className="text-center space-y-4 mb-14 max-w-2xl mx-auto">
            ...
            <h2 className="text-3xl font-serif italic tracking-tight text-charcoal">Verified partners. Better experiences<span className="brand-dot" aria-hidden="true"></span></h2>
      ...
      <section className="px-5 sm:px-6 py-20 bg-stone-50">
        <div className="max-w-5xl mx-auto space-y-16">
          <div className="text-center space-y-4 max-w-2xl mx-auto">
            <h2 className="text-3xl font-serif italic tracking-tight text-charcoal">How it works<span className="brand-dot" aria-hidden="true"></span></h2>
      ...
      <section className="px-5 sm:px-6 py-20 bg-white border-y border-stone-100">
        <div className="max-w-5xl mx-auto space-y-16">
          <div className="text-center space-y-4 max-w-2xl mx-auto">
            <h2 className="text-3xl font-serif italic tracking-tight text-charcoal">Partner Tiers<span className="brand-dot" aria-hidden="true"></span></h2>
      ...
      <section className="px-5 sm:px-6 py-20 bg-charcoal text-white text-center">
        <div className="max-w-2xl mx-auto space-y-8">
          <h2 className="text-3xl md:text-4xl font-serif italic tracking-tight">Launching first in Miami<span className="brand-dot" aria-hidden="true"></span></h2>
