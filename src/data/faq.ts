...
export const FAQ_CATEGORIES: FaqCategory[] = [
  {
    ...
    label: 'Pet Parents',
    questions: [
      { q: 'What is Hey Lola?', a: 'Hey Lola is a local ecosystem for pet parents. It helps you discover dog-friendly places, access city guides, unlock local perks, save favourites and organise your pet essentials in one place.' },
      { q: 'Is Hey Lola only for dog owners?', a: 'No. Hey Lola starts with dogs because many of the first city guides and venues are dog-friendly, but users can also add cats, other animals, or join as pet lovers without a pet.' },
      { q: 'Which cities are available first?', a: 'Hey Lola is starting city by city, with Miami, New York and Barcelona as the first focus cities.' },
  ...
  },
  {
    ...
    questions: [
      { q: 'Is Hey Lola free?', a: 'Hey Lola has a free plan and paid membership options. Founding Member access may also be available before the full public launch.' },
      { q: 'What are the membership options?', a: 'Hey Lola includes Free, Local, Plus and Black / Passport tiers. Founding Member annual passes may also be offered during early launch.' },
      { q: 'Can I cancel later?', a: 'Yes. Membership cancellation is available from the user account once payments are active.' },
      { q: 'Are payments active now?', a: 'If payments are not active yet, the buttons show "Join early access" instead of going to checkout.' },
