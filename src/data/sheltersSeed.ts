 ...
 * collection is empty. Real NYC partners + a starting set of real dogs.
 *
 * Firestore ALWAYS wins: as soon as you add/edit shelters in /admin (or run
 * scripts/import_shelters.mjs), the live data overrides this default. This
 * exists only so the page is never empty before it's been populated.
 */
